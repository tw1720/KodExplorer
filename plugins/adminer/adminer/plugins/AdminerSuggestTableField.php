...
class AdminerSuggestTableField
{
    ...
    ?>
    <style>
        #suggest_tablefields_container{min-width:200px;margin:0;padding:5px;overflow-y:auto;position:absolute;background-color:#fff;border:1px #d55d00 solid;}
        ...
        #suggest_search{width:100%;}
        #suggest_tablefields_drag{cursor:move;color:blue;}
        #suggest_tablefields_stick{cursor:pointer;color:green;}
    ...
    <script<?php echo nonce(); ?> type="text/javascript">
        ...
        domReady(() => {
            ...
            form.insertAdjacentHTML('afterbegin',
                ...
                '<span class="noselect" id="suggest_tablefields_drag">🤚 拖曳</span>｜'+
                '<span class="noselect" id="suggest_tablefields_stick" data-pos-left="'+ posLeft +'px">📌 固定</span>&nbsp;'+
                '<br /><input autocomplete="off" id="suggest_search" type="text" placeholder="<?php echo lang('Search') ?>..."/><dl id="suggest_tablefields" class="noselect"></dl></div>')
